...
function tempNavbarEdits() {
	...
	$('<div><a href="javascript:;" id="togglesidebar">Toggle Sidebar</a></div>').insertBefore("#whatever_name");
	$('<div><a href="javascript:;" id="togglenavbar">Toggle Navbar</a></div>').insertBefore("#whatever_name");
